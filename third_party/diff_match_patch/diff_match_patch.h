...
class diff_match_patch {
 ...
 public:
   ...
   */
 public:
  std::list<Diff> diff_fromDelta(std::string_view text1,
   ...
   */
 public:
  std::size_t match_main(std::string_view text, std::string_view pattern,
                         std::size_t loc);
 ...
 public:
  std::list<Patch> patch_make(const std::wstring &text1,
                              const std::wstring &text2);
  std::list<Patch> patch_make(std::string_view text1,
 ...
 public:
  ...
  std::list<Patch> patch_fromText(std::string_view textline);
